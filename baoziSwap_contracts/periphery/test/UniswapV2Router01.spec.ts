...
describe('UniswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = routerVersion == 'UniswapV2Router01' ? fixture.router01 : fixture.router02
      pair = fixture.pair
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          const gasExpectations = routerVersion == "UniswapV2Router01" ? 104316 : 104316;
      ...
      describe('swapExactTRXForTokens', () => {
        ...
        it('gas', async () => {
          ...
          const receipt = await tx.wait()
          const gasExpectations = routerVersion == "UniswapV2Router01" ? 111797 : 111797;
          expect(receipt.gasUsed).to.eq(gasExpectations)
        }).retries(3)
      })
